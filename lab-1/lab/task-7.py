...
wikiDoc = requests.get("https://en.wikipedia.org/wiki/Wikipedia");
...
print("running")
# get input
inp = open('/Users/anushakonakalla/Desktop/test.txt', 'r').read()
...
lemmetizeData = [lemmatizer.lemmatize(tagged_word[0]) for tagged_word in pos]
